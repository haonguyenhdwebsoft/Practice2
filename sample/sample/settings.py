...
SECRET_KEY = 'django-insecure-rx4s+xy_uea8=4#g6nhyfyxbp0-i$fo+1t2bl)buc*5-5as=av'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get("PG_DB", "sample_demo"),
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'apps.core.paginators.BasePagination',
    'PAGE_SIZE': 20,
}
